              ...
              <View style={styles.photoNavContainer}>
                <TouchableOpacity
                  style={[
                    ...
                    currentPhotoIndex === 0 && styles.photoNavButtonDisabled,
                  ]}
                ...
                <TouchableOpacity
                  style={[
                    styles.photoNavButton,
                    currentPhotoIndex === pet.photos.length - 1 && styles.photoNavButtonDisabled,
                  ]}
      ...
      <View style={styles.contentContainer}>
        ...
        <View style={styles.infoSection}>
          <View style={styles.infoRow}>
            <InfoItem label="Gender" value={pet.gender} icon="male-female" />
          ...
          <View style={styles.infoRow}>
            <InfoItem
              ...
              icon="medkit"
            />
            <InfoItem label="Activity" value={pet.activityLevel} icon="fitness" />
          </View>
        </View>
        ...
        {pet.preferredPlaymates && pet.preferredPlaymates.length > 0 && (
          <View style={styles.section}>
            <Text style={styles.sectionTitle}>Preferred Playmates</Text>
            <View style={styles.tagsContainer}>
...
const InfoItem = ({ label, value, icon }) => (
  <View style={styles.infoItem}>
    <Ionicons name={icon} size={20} color="#FF6B6B" style={styles.infoIcon} />
    <View>
